...
function LandingPage() {
  ...
  const liveMatches = [
    ...
    },
    {
      ...
      team1: { name: 'REG', score: 2 },
      team2: { name: 'Patriots', score: 4 },
      venue: 'BK ARENA',
      time: '33:30'
    },
    {
      competition: 'RPL | Match - 8',
      team1: { name: 'BUGESERA FC', score: 2 },
      team2: { name: 'Amagaju', score: 4 },
  ...
  // Add sports data
  const sports = [
    { name: 'BASKETBALL', divisions: ['DIVISION I', 'DIVISION II', 'DIVISION III', 'DIVISION IV'] },
    { name: 'FOOTBALL', divisions: ['PREMIER LEAGUE', 'SECOND DIVISION', 'WOMEN LEAGUE'] },
    { name: 'VOLLEYBALL', divisions: ['DIVISION I', 'DIVISION II', 'BEACH VOLLEYBALL'] },
    { name: 'HANDBALL', divisions: ['NATIONAL LEAGUE', 'SECOND DIVISION'] },
    { name: 'CYCLING', divisions: ['PROFESSIONAL', 'AMATEUR'] }
  ];
  ...
  const matchResults = [
    {
      ...
      matches: [
        {
          team1: { name: 'REG BBC', logo: '/teams/reg-bbc.svg', score: 95, record: '22-9' },
          team2: { name: 'APR BBC', logo: '/teams/apr-bbc.svg', score: 92, record: '22-9' },
          status: 'Final'
        },
        {
          team1: { name: 'APR BBC', logo: '/teams/apr-bbc.svg', score: 95, record: '22-9' },
          team2: { name: 'PATRIOT BBC', logo: '/teams/patriot-bbc.svg', score: 92, record: '22-9' },
          status: 'Final'
        }
      ]
    }
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center space-x-2">
                        <img src={`/teams/${match.team1.name}.png`} alt={match.team1.name} className="h-8 w-8" />
                    ...
                    <div className="flex justify-between items-center mb-2">
                      <div className="flex items-center space-x-2">
                        <img src={`/teams/${match.team2.name}.png`} alt={match.team2.name} className="h-8 w-8" />
            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {sports.find(sport => sport.name === selectedSport)?.divisions.map((division, index) => (
                  ...
                  >
                    <img 
                      src={`/logos/${selectedSport.toLowerCase()}.svg`}
                      alt={division}
                      className="w-12 h-12 mb-2"
                    />
                    <span className="text-xs text-center font-medium">{division}</span>
                  </div>
                ))}
              </div>
