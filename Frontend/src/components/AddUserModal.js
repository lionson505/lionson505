...
const AddUserModal = ({ user, onAdd, onUpdate, onClose }) => {
    const roles = ['pd', 'pcd', 'teacher', 'burser', 'auditor'];
    ...
    const handleSubmit = async (e) => {
        ...
        const url = user ? `http://localhost:4000/api/users/${user._id}` : 'http://localhost:4000/api/users';
