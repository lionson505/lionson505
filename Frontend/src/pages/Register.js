...
function Register() {
  ...
  const registerUser = (e) => {
    ...
    fetch("https://netcompassion-backend.onrender.com/api/register", {
      method: "POST",
      headers: {
            ...
            <div className="flex flex-col gap-4 -space-y-px rounded-md shadow-sm">
              ...
              <div>
                ...
                <select
                  name="role"
                  required
                  className="relative block w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  value={form.role}
                  onChange={handleInputChange}
                >
